    ...
    fun Player.join() {
        event {
            ...
            if (safelyAdd) {
                ...
                preTournyAttack = intArrayOf(
                    player.stats.get(StatType.Attack).fixedLevel,
                    player.stats.get(StatType.Attack).experience.toInt()
                )
                preTournyStrength = intArrayOf(
                    player.stats.get(StatType.Strength).fixedLevel,
                    player.stats.get(StatType.Strength).experience.toInt()
                )
                preTournyDefence = intArrayOf(
                    player.stats.get(StatType.Defence).fixedLevel,
                    player.stats.get(StatType.Defence).experience.toInt()
                )
                preTournyRanged = intArrayOf(
                    player.stats.get(StatType.Ranged).fixedLevel,
                    player.stats.get(StatType.Ranged).experience.toInt()
                )
                preTournyPrayer = intArrayOf(
                    player.stats.get(StatType.Prayer).fixedLevel,
                    player.stats.get(StatType.Prayer).experience.toInt()
                )
                preTournyMagic = intArrayOf(
                    player.stats.get(StatType.Magic).fixedLevel,
                    player.stats.get(StatType.Magic).experience.toInt()
                )
                preTournyHitpoints = intArrayOf(
