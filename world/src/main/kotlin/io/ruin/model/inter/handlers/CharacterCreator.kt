...
object CharacterCreator {
    ...
    init {
        InterfaceHandler.register(INTERFACE_ID) { h ->
            ...
            var hairc = 0
            h.actions[43] = DefaultAction { p, _, _, _, _ ->
                if (hairc == 0) {
                    hairc = 25
                }
            ...
            h.actions[44] = DefaultAction { p, _, _, _, _ ->
                if (hairc == 25) {
                    hairc = 0
                }
                p.appearance.colors[0] = hairc++
            ...
            var torsoc = 0
            h.actions[47] = DefaultAction { p, _, _, _, _ ->
                if (torsoc == 0) {
                    torsoc = 29
                }
            ...
            h.actions[48] = DefaultAction { p, _, _, _, _ ->
                if (torsoc == 29) {
                    torsoc = 0
                }
                p.appearance.colors[1] = torsoc++
            ...
            var legsc = 0
            h.actions[51] = DefaultAction { p, _, _, _, _ ->
                if (legsc == 0) {
                    legsc = 29
                }
            ...
            h.actions[52] = DefaultAction { p, _, _, _, _ ->
                if (legsc == 29) {
                    legsc = 0
                }
                p.appearance.colors[2] = legsc++
            ...
            var feetc = 0
            h.actions[55] = DefaultAction { p, _, _, _, _ ->
                if (feetc == 0) {
                    feetc = 7
                }
            ...
            h.actions[56] = DefaultAction { p, _, _, _, _ ->
                if (feetc == 7) {
                    feetc = 0
                }
                p.appearance.colors[3] = feetc++
            ...
            var skinc = 0
            h.actions[59] = DefaultAction { p, _, _, _, _ ->
                if (skinc == 0) {
                    skinc = 8
                }
            ...
            h.actions[60] = DefaultAction { p, _, _, _, _ ->
                if (skinc == 8) {
                    skinc = 0
                }
                p.appearance.colors[4] = skinc++
            ...
            h.actions[65] = DefaultAction { p, _, _, _, _ ->
            ...
            h.actions[66] = DefaultAction { p, _, _, _, _ ->
            ...
            h.actions[68] = DefaultAction { p, _, _, _, _ ->
                p.appearance.update()
                p.closeInterfaces()
            }
        }
