...
public enum Broadcast {
    ...
    public void sendLottery(Player player, Icon overrideIcon, String title, String message) {
        consumer.accept(player, (overrideIcon == null ? newsIcon.tag() : overrideIcon.tag()) + "<shad=000000><col=08b534>" +
                (title == null ? "Lottery:" : title + ":") + " <col=07a02f>" + message);
    }

    public void sendNews(Player player, Icon overrideIcon, String title, String message) {
        //Player only required to be set when this == FRIENDS.
        consumer.accept(player, (overrideIcon == null ? newsIcon.tag() : overrideIcon.tag()) + "<shad=000000><col=d99719>" +
                (title == null ? "" : title + ":") + " <col=c9870c>" + message);
    }
