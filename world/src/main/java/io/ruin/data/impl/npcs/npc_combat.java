...
//                    }
    ...
    public static final class Info {
        ...
        @Expose
        public double combat_xp_modifier2 = 0;
        @Expose
    ...
    public static final class WikiDumper {
        ...
        public WikiDumper run() {
            File file = null;
            try {
                Connection.Response response = Jsoup.connect("https://oldschool.runescape.wiki/w/" + URLEncoder.encode(wikiName, StandardCharsets.UTF_8))
                        .userAgent("Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:25.0) Gecko/20100101 Firefox/25.0")
                        .referrer("http://www.google.com")
                        .timeout(12000)
                        .execute();
                String url = response.url().toString();
                wikiName = URLDecoder.decode(url.substring(url.lastIndexOf("/") + 1), StandardCharsets.UTF_8);
