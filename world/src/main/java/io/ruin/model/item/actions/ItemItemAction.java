...
public interface ItemItemAction {
    ...
    static void register(int primaryId, int secondaryId, int thirdId, ItemItemAction action) {
        action.register(primaryId, true);
        action.register(secondaryId, false);
        action.register(thirdId, false);
    }
    static void register(int primaryId, int secondaryId, int thirdId, int fourthId, int fifthId, ItemItemAction action) {
        action.register(primaryId, true);
        action.register(secondaryId, false);
        action.register(thirdId, false);
        action.register(fourthId, false);
        action.register(fifthId, false);
    }
