...
public class TridentOfTheSwampE {

    public static final int CHARGED = 22292;
    public static final int UNCHARGED = 22294;
    private static final List<Item> CHARGE_ITEMS;
    ...
    static {
        ...
        for (Item item : CHARGE_ITEMS) {
            ItemItemAction.register(CHARGED, item.getId(), TridentOfTheSwampE::charge);
            ItemItemAction.register(UNCHARGED, item.getId(), TridentOfTheSwampE::charge);
        }
        ItemAction.registerInventory(CHARGED, "check", TridentOfTheSwampE::check);
        ItemAction.registerEquipment(CHARGED, "check", TridentOfTheSwampE::check);
        ItemAction.registerInventory(CHARGED, "uncharge", TridentOfTheSwampE::uncharge);
        ItemDef.get(CHARGED).addPreTargetDefendListener(TridentOfTheSwampE::consumeCharge);
        ItemAction.registerInventory(CHARGED, "drop", TridentOfTheSwampE::drop);
        ItemAction.registerInventory(UNCHARGED, "dismantle", TridentOfTheSwampE::dismantle);
        ItemItemAction.register(TridentOfTheSeas.UNCHARGED, 12932, TridentOfTheSwampE::combine);
        ItemItemAction.register(TridentOfTheSeas.CHARGED, 12932, TridentOfTheSwampE::wrongCombine);
        ItemItemAction.register(TridentOfTheSeas.FULLY_CHARGED, 12932, TridentOfTheSwampE::wrongCombine);
    }
