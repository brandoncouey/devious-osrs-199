...
public enum RingOfWealth {
    ...
    public static void toggleBMCollect(Player player) {
    ...
    public static void toggleEtherCollect(Player player) {
    ...
    public static boolean has1Loot(Player player) {
            if (player.lootit = true) {
                return true;
            }
        return false;
    }
