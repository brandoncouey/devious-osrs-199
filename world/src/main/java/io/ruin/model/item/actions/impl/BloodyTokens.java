...
public class BloodyTokens {
    ...
    public static final int BLOODY_TOKENS = 30309;
        ...
        player.dialogue(
                new OptionsDialogue("Exchange your blood money for bloody tokens?",
                        new Option("Yes", () -> {
                            ...
                            player.dialogue(new ItemDialogue().two(30309, 13307, "The bank exchanges your blood money for bloody tokens."));
                        }),
        ...
        player.dialogue(
                new OptionsDialogue("Exchange your bloody tokens for blood money?",
                        new Option("Yes", () -> {
                            ...
                            player.dialogue(new ItemDialogue().two(13307, 30309, "The bank exchanges your bloody tokens for blood money."));
                        }),
                        new Option("No", player::closeDialogue)
                )
        );
