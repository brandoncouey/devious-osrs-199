...
public class Title {
    ...
    public static final Title[] PRESET_TITLES = {
            prefixTitle("<col=0da8af><shad=000000><img=1>Owner </col></shad>").setPredicate(p -> p.isGroup(PlayerGroup.OWNER)).setHidden(),
            prefixTitle("<col=ffff00><shad=000000><img=51>Admin </col></shad>").setPredicate(p -> p.isGroup(PlayerGroup.ADMINISTRATOR)).setHidden(),
            prefixTitle("<col=a239db><shad=000000><img=1>Developer </shad></col>").setPredicate(p -> p.isGroup(PlayerGroup.DEVELOPER)).setHidden(),
            prefixTitle("<col=d6daff><shad=000000><img=0>Moderator </shad></col>").setPredicate(p -> p.isGroup(PlayerGroup.MODERATOR)).setHidden(),
            prefixTitle(colorAndShadow("0033cc", "000000", "Support ")).setPredicate(p -> p.isGroup(PlayerGroup.SUPPORT)).setHidden(),
            prefixTitle(colorAndShadow("0033cc", "000000", "Completionist ")).setPredicate(p -> p.achievedComp).setHidden(),
            prefixTitle(colorAndShadow("6600FF", "000000", "Adamant ")).setPredicate(Player::isEmeraldDonator).setHidden(),
            prefixTitle(colorAndShadow("B9F2FF", "000000", "Mithril ")).setPredicate(Player::isSapphireDonator).setHidden(),
            prefixTitle(colorAndShadow("9b111e", "000000", "Gold ")).setPredicate(Player::isRedTopazDonator).setHidden(),
            prefixTitle(colorAndShadow("0f52ba", "000000", "Bronze ")).setPredicate(Player::isOpalDonator).setHidden(),
            prefixTitle(colorAndShadow("0f52ba", "000000", "Dragon ")).setPredicate(Player::isDiamondDonator).setHidden(),
            prefixTitle(colorAndShadow("0f52ba", "000000", "Rune ")).setPredicate(Player::isRubyDonator).setHidden(),
...
/*            prefixTitle(colorAndShadow("9e9e9e", "000000", "Ironman ")).setPredicate(p -> p.getGameMode() == GameMode.IRONMAN).setHidden(),
            ...
            prefixTitle(color("13a5f9", "EatSleepDevious ")).setUnlockDescription(""),
            ...
            prefixTitle(colorAndShadow("bfbfbf", "000000", "<img=23>Dice Host ")).setPredicate(p -> p.diceHost).setUnlockDescription("Purchase a Dice Bag"),
            ...
            prefixTitle(colorAndShadow("FF2d00", "000000", "Custom Title2 ")).setPredicate(p -> p.hasCustomTitle).setUnlockDescription("Purchase Custom Title from the Store")
    };
    ...
    private static final List<Title> sortedList = new ArrayList<>();
    ...
    private static final String[] bannedTitles = {"admin", "administrator", "owner", "mod"};
