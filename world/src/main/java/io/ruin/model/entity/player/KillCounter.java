...
public class KillCounter {
    ...
    private static final List<Function<Player, KillCounter>> bossList;
    private static final List<Function<Player, KillCounter>> slayerList;
    ...
    static {
        ...
        set(p -> p.hydraKills, "alchemical hydra");
        set(p -> p.sarachnisKills, "sarachnis");

        set(p -> p.barrowsKills, "dharok");
        set(p -> p.barrowsKills, "ahrim");
        set(p -> p.barrowsKills, "karil");
        set(p -> p.barrowsKills, "guthan");
        set(p -> p.barrowsKills, "verac");
        set(p -> p.barrowsKills, "torag");
        /* Slayer monsters */
        ...
        set(p -> p.fireGiantKills, "fire giant");
        set(p -> p.jellyKills, "jelly");
        set(p -> p.turothKills, "turoth");
        set(p -> p.mithrildragKills, "mithril dragon");
        set(p -> p.blackdragonKills, "black dragon");
        set(p -> p.mutatedZygomiteKills, "mutated Zygomite");
        set(p -> p.caveHorrorKills, "cave Horror");
        set(p -> p.aberrantSpectreKills, "Spectre");
...
//        set(p -> p.superiorCreatureKills, "superior Creature"); // need a proper way to add this
        ...
        set(p -> p.battleMageKills, "battle mage");
        ...
        LoginListener.register(p -> {
            ...
            p.hydraKills.setName("Alchemical hydra").messageOnKill();
            p.crawlingHandKills.setName("Crawling Hands");
            p.barrowsKills.setName("Ahrim the Blighted");
            p.barrowsKills.setName("Dharok the Wretched");
            p.barrowsKills.setName("Torag the Corrupted");
            p.barrowsKills.setName("Guthan the Infested");
            p.barrowsKills.setName("Karil the Tainted");
            p.barrowsKills.setName("Verac the Defiled");
...
//                p -> p.brineRatKills,
                ...
                p -> p.jellyKills,
                p -> p.turothKills,
                p -> p.mithrildragKills,
                p -> p.blackdragonKills,
