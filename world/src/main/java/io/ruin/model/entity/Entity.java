...
public abstract class Entity {
    ...
    private void face(int absX, int absY, int xLength, int yLength) {
        ...
        if (player != null) {
            ...
            if (i_35_ != 0 || i_36_ != 0)
                mapDirectionUpdate.set((int) (Math.atan2(i_35_, i_36_) * 325.949) & 0x7ff);
            return;
        }
    ...
    private final TickDelay freezeDelay = new TickDelay();
    ...
    private final TickDelay stunDelay = new TickDelay();
    ...
    private final TickDelay rootDelay = new TickDelay();
