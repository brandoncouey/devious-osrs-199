...
public class PlayerUpdater {
    ...
    private final byte[] skipData = new byte[2048];

    private int localCount = 0;
    private final int[] localIndexes = new int[2048];
    protected boolean[] local = new boolean[2048];

    private int globalCount = 0;
    private final int[] globalIndexes = new int[2048];
    private final int[] globalRegionHashes = new int[2048];
