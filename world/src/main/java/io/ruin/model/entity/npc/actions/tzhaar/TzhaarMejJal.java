...
public class TzhaarMejJal {
    ...
    private static void bargain(Player player, NPC npc) {
        if (player.getInventory().hasId(Pets.TZREK_JAD.itemId) || player.getBank().hasId(Pets.TZREK_JAD.itemId) || (player.pet != null && player.pet == Pets.TZREK_JAD)) {
