...
public class BarrowsRewards {
    ...
    private static final LootTable miscUniqueTable = new LootTable()
            ...
            .addTable(1,
                    ...
                    new LootItem(12073, 1, 100)   // clue scroll (elite)
            );
    ...
    public static ItemContainer loot(Player player) {
        ...
        int wellOfGoodWillChance = WellofGoodwill.isActive() ? 4 : 2;
        double customBarrowsChance = barrowsChance * wellOfGoodWillChance;
