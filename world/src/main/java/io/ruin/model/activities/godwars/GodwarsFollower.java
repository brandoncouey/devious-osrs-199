...
public class GodwarsFollower {
    ...
    private static final Bounds GODWARS = new Bounds(2817, 5183, 2941, 5373, -1);

    private static final Predicate<ItemDef> ARMADYL_ITEM = def -> def.name.toLowerCase().contains("armadyl") || def.name.equalsIgnoreCase("book of law") || def.name.equalsIgnoreCase("honourable blessing");
    ...
    private static final Predicate<ItemDef> BANDOS_ITEM = def -> def.name.toLowerCase().contains("bandos") || def.name.equalsIgnoreCase("book of war") || def.name.equalsIgnoreCase("war blessing");
    private static final Predicate<ItemDef> ZAROS_ITEM = def -> def.name.toLowerCase().contains("ancient") || def.name.toLowerCase().contains("zaryte") || def.name.toLowerCase().contains("torva") || def.name.equalsIgnoreCase("book of darkness") || def.name.equalsIgnoreCase("ancient blessing");
