...
public class JewelledCrabsChamber extends Chamber {
    ...
    public enum Color {
        ...
        ;
        private final int energyId; // npc id of the energy thing of this color
        public int crabId; // the crab of this color
        private final int crystalId; // the correct crystal the energy thing of this color should go to (opposite color)
    ...
    private static final int[][] blockingCrystals = {
            {8, 21}, // layout 0
            {12, 22}, // layout 1
            {21, 22}, // layout 2
    };

    private static final int[][][] crabSpawns = {
            {
                    {16, 19},
                    {20, 22},
                    {21, 18},
    ...
    private static final int[] startingDirections = { // index to ^
            3, // layout 0
            0, // layout 1
            1, // layout 2
    };
