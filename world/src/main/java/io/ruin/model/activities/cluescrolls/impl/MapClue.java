...
public class MapClue extends Clue {
    ...
    static {
        ...
        registerDig(87, 3300, 3291, 0, ClueType.EASY);
        registerDig(337, 2970, 3415, 0, ClueType.EASY);
        registerDig(338, 3021, 3912, 0, ClueType.HARD);
        registerDig(339, 2722, 3338, 0, ClueType.HARD);
        registerDig(340, 2536, 3865, 0, ClueType.MEDIUM);
        registerDig(341, 3434, 3265, 0, ClueType.MEDIUM);
        registerDig(342, 2454, 3230, 0, ClueType.MEDIUM);
        registerDig(343, 2578, 3597, 0, ClueType.MEDIUM);
        registerDig(344, 2666, 3562, 0, ClueType.MEDIUM);
        registerDig(346, 3166, 3361, 0, ClueType.EASY);
        registerDig(347, 3290, 3374, 0, ClueType.EASY);
        registerDig(348, 3091, 3227, 0, ClueType.MEDIUM);
        registerDig(351, 3043, 3398, 0, ClueType.EASY);
        registerDig(352, 2907, 3295, 0, ClueType.MEDIUM);
        registerDig(353, 2615, 3078, 0, ClueType.HARD);
