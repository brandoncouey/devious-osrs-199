...
public enum ClueType {
    ...
    private static String message = "Great job, you have completed your clue scroll!";
    ...
    static {
        ...
        ItemAction.registerInventory(24361, "open", (player, item) -> {
            ...
            int box = player.getInventory().count(24361);
            message = " You have now completed a total of " + NumberUtils.formatNumber(player.beginnerClueCount += box) + " beginner clue scrolls!";
            player.dialogue(new ItemDialogue().one(23182, message));
            player.sendMessage(message);
            item.remove(box);
            player.getInventory().add(23245,box);
        });
        ItemAction.registerInventory(24362, "open", (player, item) -> {
            ...
            int box = player.getInventory().count(24362);
            message = " You have now completed a total of " + NumberUtils.formatNumber(player.easyClueCount += box) + " easy clue scrolls!";
            player.dialogue(new ItemDialogue().one(20546, message));
            player.sendMessage(message);
            item.remove(box);
            player.getInventory().add(20546,box);
        });
        ItemAction.registerInventory(24363, "open", (player, item) -> {
            ...
            int box = player.getInventory().count(24363);
            message = " You have now completed a total of " + NumberUtils.formatNumber(player.medClueCount += box) + " medium clue scrolls!";
            player.dialogue(new ItemDialogue().one(20545, message));
            player.sendMessage(message);
            item.remove(box);
            player.getInventory().add(20545, box);
        });
        ItemAction.registerInventory(24364, "open", (player, item) -> {
            ...
            int box = player.getInventory().count(24364);
            message = " You have now completed a total of " + NumberUtils.formatNumber(player.hardClueCount += box) + " hard clue scrolls!";
            player.dialogue(new ItemDialogue().one(20544, message));
            player.sendMessage(message);
            item.remove(box);
            player.getInventory().add(20544, box);
        });
        ItemAction.registerInventory(24365, "open", (player, item) -> {
            ...
            int box = player.getInventory().count(24365);
            message = " You have now completed a total of " + NumberUtils.formatNumber(player.eliteClueCount += box) + " elite clue scrolls!";
            player.dialogue(new ItemDialogue().one(20543, message));
            player.sendMessage(message);
            item.remove(box);
            player.getInventory().add(20543, box);
        });
        ItemAction.registerInventory(24366, "open", (player, item) -> {
            ...
            int box = player.getInventory().count(24366);
            message = " You have now completed a total of " + NumberUtils.formatNumber(player.masterClueCount += box) + " master clue scrolls!";
            player.dialogue(new ItemDialogue().one(19836, message));
            player.sendMessage(message);
            item.remove(box);
            player.getInventory().add(19836,box);
        });
    }
