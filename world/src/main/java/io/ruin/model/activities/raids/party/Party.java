package io.ruin.model.activities.raids.party;
...
//    private ChambersOfXeric raid;
    ...
    public void setRaid(ChambersOfXeric raid) {
        this.raid = raid;
       /* if (raid instanceof ChambersOfXeric) {
            type = RaidDungeonType.CHAMBERS_OF_XERIC;
        } else {
            type = RaidDungeonType.THEATRE_OF_BLOOD;
        }*/
    }
    ...
    public static void sendRaidJournal(Player player, Party party) {
        ...
        JournalTab.swap(player, Interface.RAIDING_JOURNAL);
