...
public class Barrows {
    ...
    private static void loot(Player player) {
        ...
        player.startEvent(e -> {
            ...
            if (player.barrowsChestsOpened == 10 || player.barrowsChestsOpened >= 10) {
                player.openInterface(InterfaceType.SECONDARY_OVERLAY, 660);
                player.getPacketSender().sendClientScript(3343, "iss", 0xff981f, "Combat Task Completed!", "Task Completed:" + Color.WHITE.wrap(" Barrows Novice"));
