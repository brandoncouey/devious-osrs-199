...
public class ShopItem extends Item {
    ...
    public ShopItem(int id, int amount, int price, int uniqueValue) {
    ...
    public ShopItem copy() {
        ShopItem shopItem = new ShopItem(getId(), getAmount(), getPrice());
