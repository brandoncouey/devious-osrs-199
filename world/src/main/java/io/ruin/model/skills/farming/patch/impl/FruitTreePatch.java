...
public class FruitTreePatch extends RegrowPatch {
    ...
    private void checkHealth() {
        ...
        player.getStats().addXp(StatType.Farming, getPlantedCrop().getCheckHealthXP() * FarmingSet.FarmingSet(player), true);
    ...
    private void chop() {
        ...
        player.startEvent(event -> {
            ...
            advanceStage();
            update();
            player.getStats().addXp(StatType.Woodcutting, 1 * FarmingSet.FarmingSet(player), false);
