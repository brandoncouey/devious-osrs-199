...
public class RedwoodTreePatch extends Patch {
    ...
    public boolean canPlant(Crop crop) {
        return crop instanceof RedwoodTreeCrop;
    }
    ...
    @Override
    public RedwoodTreeCrop getPlantedCrop() {
        return super.getPlantedCrop() == null ? null : (RedwoodTreeCrop) super.getPlantedCrop();
    }
