...
public enum LogCutting {
    ...
    OAK_JAV(1521, 15, 10.0, new Item(19584, 30), "30 javelin shafts", "fletch Javelin shafts"),
    ...
    WILLOW_JAV(1519, 30, 15.0, new Item(19584, 45), "45 javelin shafts", "fletch Javelin shafts"),
    ...
    MAPLE_JAV(1517, 45, 20.0, new Item(19584, 60), "60 javelin shafts", "fletch Javelin shafts"),
    ...
    //Teak log
    TEAK_SHAFT(6333, 50, 20.0, new Item(52, 65), "65 arrow shafts", "make shafts from teak logs"),
    TEAK_JAV(6333, 50, 20.0, new Item(19584, 65), "65 javelin shafts", "fletch Javelin shafts"),
    TEAK_STOCK(6333, 54, 32.0, new Item(9446, 1), "a crossbow stock", "make a Teak Stock"),

    //Yew log
    YEW_SHAFT(1515, 60, 25.0, new Item(52, 75), "75 arrow shafts", "make shafts from yew logs"),
    YEW_JAV(1515, 60, 25.0, new Item(19584, 75), "75 javelin shafts", "fletch Javelin shafts"),
    ...
    MAGIC_JAV(1513, 75, 30.0, new Item(19584, 90), "90 javelin shafts", "fletch Javelin shafts"),
    ...
    REDWOOD_JAV(19669, 90, 35.0, new Item(19584, 105), "105 javelin shafts", "fletch Javelin shafts"),
    ...
    static {
        ...
        ItemItemAction.register(Tool.KNIFE, OAK_LOG, (player, knife, oakLog) -> {
            SkillDialogue.make(player,
                    item(OAK_SHAFT),
                    new SkillItem(OAK_JAV.item.getId()).addAction((p, amount, event) -> cut(p, OAK_JAV, amount)),
        ...
        ItemItemAction.register(Tool.KNIFE, WILLOW_LOG, (player, knife, willowLog) -> {
            SkillDialogue.make(player,
                    item(WILLOW_SHAFT),
                    new SkillItem(WILLOW_JAV.item.getId()).addAction((p, amount, event) -> cut(p, WILLOW_JAV, amount)),
        ...
        ItemItemAction.register(Tool.KNIFE, MAPLE_LOG, (player, knife, mapleLog) -> {
            SkillDialogue.make(player,
                    item(MAPLE_SHAFT),
                    new SkillItem(MAPLE_JAV.item.getId()).addAction((p, amount, event) -> cut(p, MAPLE_JAV, amount)),
        ...
        ItemItemAction.register(Tool.KNIFE, TEAK_LOG, (player, knife, mapleLog) -> {
            SkillDialogue.make(player,
                    item(TEAK_SHAFT),
                    new SkillItem(TEAK_JAV.item.getId()).addAction((p, amount, event) -> cut(p, TEAK_JAV, amount)),
        ...
        ItemItemAction.register(Tool.KNIFE, YEW_LOG, (player, knife, yewLog) -> {
            SkillDialogue.make(player,
                    item(YEW_SHAFT),
                    new SkillItem(YEW_JAV.item.getId()).addAction((p, amount, event) -> cut(p, YEW_JAV, amount)),
        ...
        ItemItemAction.register(Tool.KNIFE, MAGIC_LOG, (player, knife, magicLog) -> {
            SkillDialogue.make(player,
                    item(MAGIC_SHAFT),
                    item(MAGIC_STAFF),
                    new SkillItem(MAGIC_JAV.item.getId()).addAction((p, amount, event) -> cut(p, MAGIC_JAV, amount)),
        ...
        ItemItemAction.register(Tool.KNIFE, 19669, (player, knife, magicLog) -> {
            SkillDialogue.make(player,
                    new SkillItem(REDWOOD_JAV.item.getId()).addAction((p, amount, event) -> cut(p, REDWOOD_JAV, amount)),
                    item(REDWOOD_SHAFT),
                    item(REDWOOD_STAFF));
        });
