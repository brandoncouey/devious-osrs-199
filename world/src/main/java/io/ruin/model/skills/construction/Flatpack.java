...
public enum Flatpack {
    ...
    private static final Flatpack[] ARMCHAIRS = {CRUDE_CHAIR, WOODEN_CHAIR, ROCKING_CHAIR, OAK_CHAIR, OAK_ARMCHAIR, TEAK_ARMCHAIR, MAHOGANY_ARMCHAIR};
    private static final Flatpack[] BOOKCASES = {WOODEN_BOOKCASE, OAK_BOOKCASE, MAHOGANY_BOOKCASE};
    private static final Flatpack[] BARRELS = {BEER_BARREL, CIDER_BARREL, ASGARNIAN_ALE_BARREL, GREENMANS_ALE_BARREL, DRAGON_BITTER, CHEFS_DELIGHT_BARREL};
    private static final Flatpack[] KITCHEN_TABLES = {KITCHEN_TABLE, OAK_KITCHEN_TABLE, TEAK_KITCHEN_TABLE};
    private static final Flatpack[] DINING_TABLES = {WOOD_DINING_TABLE, OAK_DINING_TABLE, CARVED_OAK_TABLE, TEAK_TABLE, CARVED_TEAK_TABLE, MAHOGANY_TABLE, OPULENT_TABLE};
    private static final Flatpack[] DINING_BENCHES = {WOODEN_BENCH, OAK_BENCH, CARVED_OAK_BENCH, TEAK_BENCH, CARVED_TEAK_BENCH, MAHOGANY_BENCH, GILDED_BENCH};
    private static final Flatpack[] BEDS = {WOODEN_BED, OAK_BED, LARGE_OAK_BED, TEAK_BED, LARGE_TEAK_BED, FOUR_POSTER, GILDED_FOUR_POSTER};
    private static final Flatpack[] DRESSERS = {SHAVING_STAND, OAK_SHAVING_STAND, OAK_DRESSER, TEAK_DRESSER, FANCY_TEAK_DRESSER, MAHOGANY_DRESSER, GILDED_DRESSER};
    private static final Flatpack[] WARDROBES = {SHOE_BOX, OAK_DRAWERS, OAK_WARDROBE, TEAK_DRAWERS, TEAK_WARDROBE, MAHOGANY_WARDROBE, GILDED_WARDROBE};
    private static final Flatpack[] CLOCKS = {OAK_CLOCK, TEAK_CLOCK, GILDED_CLOCK};
    private static final Flatpack[] CAPE_RACKS = {OAK_CAPE_RACK, TEAK_CAPE_RACK, MAHOGANY_CAPE_RACK, GILDED_CAPE_RACK, MARBLE_CAPE_RACK, MAGICAL_CAPE_RACK};
    private static final Flatpack[] MAGIC_WARDROBES = {OAK_MAGIC_WARDROBE, CARVED_OAK_MAGIC_WARDROBE, TEAK_MAGIC_WARDROBE, CARVED_TEAK_MAGIC_WARDROBE, MAHOGANY_MAGIC_WARDROBE, GILDED_MAGIC_WARDROBE, MARBLE_MAGIC_WARDROBE};
    private static final Flatpack[] ARMOUR_CASES = {OAK_ARMOUR_CASE, TEAK_ARMOUR_CASE, MAHOGANY_ARMOUR_CASE};
    private static final Flatpack[] TREASURE_CHESTS = {OAK_TREASURE_CHEST, TEAK_TREASURE_CHEST, MAHOGANY_TREASURE_CHEST};
    private static final Flatpack[] FANCY_DRESS_BOXES = {OAK_FANCY_BOX, TEAK_FANCY_BOX, MAHOGANY_FANCY_BOX};
    private static final Flatpack[] TOY_BOXES = {OAK_TOY_BOX, TEAK_TOY_BOX, MAHOGANY_TOY_BOX};
