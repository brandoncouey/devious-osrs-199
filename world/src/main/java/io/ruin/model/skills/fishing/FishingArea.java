...
public enum FishingArea {
    ...
    DONATOR_ZONE(
            new Position(3810, 2824, 1),
            new Position(3809, 2823, 1),
            new Position(3810, 2822, 1),
            new Position(3811, 2823, 1)
    ),
    LAVA_MAZE(
    ...
    NEW_HOME(
            new Position(3522, 3127, 0),
            new Position(3522, 3216, 0),
            new Position(3522, 3125, 0),
            new Position(3522, 3124, 0)

    ),
    NEW_HOME2(
            new Position(3524, 3128, 0),
            new Position(3525, 3128, 0),
            new Position(3526, 3128, 0),
            new Position(3257, 3128, 0)
    ...
    static {
        try {
            ...
            DONATOR_ZONE.add(FishingSpot.MINNOWS, 1);
            DONATOR_ZONE.add(FishingSpot.NET_BAIT, 1);
            NEW_HOME.add(FishingSpot.CAGE_HARPOON, 1);
            NEW_HOME2.add(FishingSpot.BIG_NET_HARPOON, 1);
            LAVA_MAZE.add(FishingSpot.MOLTEN_EEL, 3);
