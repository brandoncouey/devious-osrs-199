...
public class PresetCustom extends Preset {
    ...
    public static final PresetCustom[] ENTRIES = {
            ...
            new PresetCustom(4),
            new PresetCustom(5),
            new PresetCustom(6, SecondaryGroup.OPAL, SecondaryGroup.RED_TOPAZ, SecondaryGroup.SAPPHIRE, SecondaryGroup.EMERALD, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(7, SecondaryGroup.RED_TOPAZ, SecondaryGroup.SAPPHIRE, SecondaryGroup.EMERALD, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(8, SecondaryGroup.SAPPHIRE, SecondaryGroup.EMERALD, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(9, SecondaryGroup.EMERALD, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(10, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(11, SecondaryGroup.DIAMOND),
    };
    ...
    public static final PresetCustom[] ECO_ENTRIES = {
            ...
            new PresetCustom(8),
            new PresetCustom(9),
            new PresetCustom(1, SecondaryGroup.OPAL, SecondaryGroup.RED_TOPAZ, SecondaryGroup.SAPPHIRE, SecondaryGroup.EMERALD, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(2, SecondaryGroup.RED_TOPAZ, SecondaryGroup.SAPPHIRE, SecondaryGroup.EMERALD, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(3, SecondaryGroup.SAPPHIRE, SecondaryGroup.EMERALD, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(4, SecondaryGroup.EMERALD, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(5, SecondaryGroup.RUBY, SecondaryGroup.DIAMOND),
            new PresetCustom(6, SecondaryGroup.DIAMOND),
    };
    ...
    private final SecondaryGroup[] donatorGroups;
