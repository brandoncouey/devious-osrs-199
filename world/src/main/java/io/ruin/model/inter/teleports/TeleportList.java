...
public class TeleportList {
    ...
    public enum Category {
        ...
        CITIES(
                ...
                Teleport.REMINGTON,
                Teleport.VARROCK,
                Teleport.GREAT_KOUREND,
                Teleport.KEBOS_LOWLANDS,
                Teleport.KARAMJA_DOCKS,
                Teleport.LUMBRIDGE,
                Teleport.LLEYTA,
                Teleport.LUNAR_ISLE,
                Teleport.MOS_LE_HARMLESS,
                Teleport.NEITIZNOT,
                Teleport.POLLNIVNEACH,
                Teleport.PORT_SARIM,
                Teleport.PRIFDDINAS,
                Teleport.RELLEKKA,
                Teleport.SEERS_VILLAGE,
                Teleport.SHILO_VILLAGE,
                Teleport.TREE_GNOME_STRONGHOLD,
                Teleport.VARROCK,
                Teleport.DARKMEYER,
                Teleport.WATERBIRTH_ISLAND,
                Teleport.YANILLE
        ),
        ...
        MINIGAMES(
                ...
                10,
                Teleport.BARROWS,
                Teleport.BLAST_FURNACE,
                Teleport.CASTLE_WARS,
                Teleport.CHAMBERS_OF_XERIC,
                Teleport.DUEL_ARENA,
                Teleport.FIGHT_CAVE,
                Teleport.INFERNO,
                Teleport.LAST_MAN_STANDING,
                Teleport.MOTHERLODE_MINE,
                Teleport.PEST_CONTROL,
                Teleport.PURO_PURO,
                Teleport.PYRAMID_PLUNDER,
                Teleport.WARRIORS_GUILD,
                Teleport.WINTERTODT
        ),
        ...
        SKILLING(
                ...
                Teleport.RED_CHINS,
                Teleport.ABYSS,
                Teleport.AERIAL_FISHING,
                Teleport.BARB_FISHING,
                Teleport.COOKING_GUILD,
                Teleport.CRAFTING_GUILD,
                Teleport.DENSE_ESSENCE,
                Teleport.DESERT_HUNTER,
                Teleport.FELDIP_HILLS,
                Teleport.FISHING_GUILD,
                Teleport.GEM_MINE,
                Teleport.GNOME_AGILITY,
                Teleport.JATIZSO_MINE,
                Teleport.KARAMJA_DOCKS,
                Teleport.KARAMBWAN_FISHING,
                Teleport.KOUREND_ANGLERS,
                Teleport.BLACK_CHINS,
                Teleport.MINING_GUILD,
                Teleport.MISCELLANIA,
                Teleport.PISCATORIS_FISHING_COLONY,
                Teleport.PURE_ESSENCE_MINING,
                Teleport.RANGING_GUILD,
                Teleport.WOODCUTTING_GUILD,
        ...
        MONSTERS(
                ...
                10,
                10,
                Teleport.EASY_TRAINING,
                Teleport.MED_TRAINING,
                Teleport.AMMONITE_CRABS,
                Teleport.APE_ATOLL,
                Teleport.BANDIT_CAMP,
                Teleport.EXPERIMENTS,
                Teleport.GOBLINS,
                Teleport.LIZARD_CANYON,
                Teleport.MORYTANIA_SLAYER_TOWER,
                Teleport.ROCK_CRABS,
                Teleport.SAND_CRABS,
                Teleport.STRONGHOLD_SECURITY,
                Teleport.TROLLHEIM_TROLLS,
                Teleport.MANIACAL_MONKIES
        ),
        ...
        DUNGEONS(
                ...
                10,
                10,
                Teleport.ANCIENT_CAVERN,
                Teleport.ASGARNIA_ICE_CAVE,
                Teleport.BASILISK_KNIGHT_CAVE,
                Teleport.BRIMHAVEN_DUNGEON,
                Teleport.BRINE_RAT_CAVERN,
                Teleport.CATACOMBS_OF_KOUREND,
                Teleport.CRASH_SITE_CAVERN,
                Teleport.EDGEVILLE_DUNGEON,
                Teleport.FIRE_CHASM,
                Teleport.FORTHOS_DUNGEON,
                Teleport.GODWARS_DUNGEON,
                Teleport.LITHKREN_LABORATORY,
                Teleport.Lighthouse_Dungeon,
                Teleport.LUMBRIDGE_SWAMPCAVES,
                Teleport.MOS_LE_HARMLESS_DUNGEON,
                Teleport.MOUNT_KARUULM,
                Teleport.MOURNER_TUNNELS,
                Teleport.RELLEKA_SLAYER_CAVE,
                Teleport.TAVERLY_DUNGEON,
                Teleport.SMOKE_DUNGEON,
                Teleport.STRONGHOLD_SLAYER_CAVE,
                Teleport.SLAYER_TOWER,
                Teleport.JUNGLE_DEMONS,
                Teleport.Waterfall_Dungeon),
        ...
        BOSSES(
                ...
                10,
                10,
                Teleport.DONATION_BOSS,
                Teleport.VOTE_BOSS,
                Teleport.ABYSSAL_SIRE,
                Teleport.CERBERUS,
                Teleport.CORPOREAL_BEAST,
                Teleport.DAGGANOTH_LAIR,
                Teleport.GALVEK,
                Teleport.GIANT_MOLE,
                Teleport.GODWARS_DUNGEON,
                Teleport.KALPHITE_QUEEN,
                Teleport.TOB,
                Teleport.KING_BLACK_DRAGON,
                Teleport.KRAKEN,
                Teleport.NIGHTMARE_OF_ASHIHAMA,
                Teleport.SMOKE_DEVIL,
                Teleport.VORKATH,
                Teleport.NEX,
                Teleport.ZULRAH
        ),
        ...
        WILDERNESS(
                ...
                10,
                10,
                Teleport.CHAOS_ELEMENTAL,
                Teleport.EAST_DRAGONS,
                Teleport.FEROX_ENCLAVE,
                Teleport.GRAVEYARD_OF_SHADOWS,
                Teleport.GREATER_DEMONS,
                Teleport.ICE_PLATEAU,
                Teleport.LAVA_MAZE,
                Teleport.MAGE_BANK,
                Teleport.REVENANTS,
                Teleport.RESOURCE_AREA,
                Teleport.WEST_DRAGONS
        ),
    ...
    public enum Teleport {
        ...
        TAVERLY(3, TeleportConstants.TAVERLY),
        REMINGTON(3, TeleportConstants.REMINGTON),
        ...
        //TRAINING
        EASY_TRAINING(55, "Lumbridge Cows", TeleportConstants.COWS, false, false),
        MED_TRAINING(56, "Sand Crabs", TeleportConstants.SAND_CRABS, false, false),
        ...
        BLACK_CHINS(108, "Black Chinchompas", TeleportConstants.BLACK_CHINS, true, false),
