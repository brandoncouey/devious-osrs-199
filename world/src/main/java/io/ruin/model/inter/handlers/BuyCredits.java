...
//                        player.unsafeDialogue(new MessageDialogue("After you have purchased credits, you can claim them from the Donation Manager in Devious or by using the ::claim command.").lineHeight(24));
//                    }),
