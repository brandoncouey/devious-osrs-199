...
public class SpiritTree {
    ...
    private static final List<PatchData> SPIRIT_TREE_PATCHES = Arrays.asList(PatchData.PORT_SARIM_SPIRIT_TREE, PatchData.BRIMHAVEN_SPIRIT_TREE, PatchData.ETCETERIA_SPIRIT_TREE, PatchData.ZEAH_SPIRIT_TREE);
    private static final String[] PATCH_NAMES = {"Port Sarim", "Brimhaven", "Etceteria", "Zeah"};
