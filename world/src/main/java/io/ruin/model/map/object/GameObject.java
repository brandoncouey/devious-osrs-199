...
public class GameObject extends AttributesHolder {
    ...
    public GameObject(int id, int x, int y, int z, int type, int direction, String ownerName, int ownerId, boolean ownerUseOnly) {
        this.id = id;
        this.originalId = id;
        this.x = x;
        this.y = y;
        ...
        this.onlyOwnerUse = ownerUseOnly;
    }
    ...
    public static GameObject spawn(int id, int x, int y, int z, int type, int direction, String chestOwnerName, int chestOwnerId, boolean ownerUseOnly) {
        return new GameObject(id, x, y, z, type, direction, chestOwnerName, chestOwnerId, ownerUseOnly).spawn();
    }
