...
//                HouseStyle.FANCY_STONE.doorId1, HouseStyle.FANCY_STONE.doorId2,
        ...
        ObjectAction.register(2039, 2517, 3356, 0, "open", (player, obj) -> player.sendFilteredMessage("The door seems to be stuck."));
        ObjectAction.register(2041, 2518, 3356, 0, "open", (player, obj) -> player.sendFilteredMessage("The door seems to be stuck."));
