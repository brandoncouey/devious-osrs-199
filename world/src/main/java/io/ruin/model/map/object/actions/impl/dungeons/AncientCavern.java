...
public class AncientCavern {
    ...
    static {
        ...
        ObjectAction.register(32211, 1, (player, obj) -> player.getMovement().teleport(1744, 5325, 0));
        ObjectAction.register(32212, 1, (player, obj) -> player.getMovement().teleport(1744, 5321, 1));
