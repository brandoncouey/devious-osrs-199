...
public class WorldList {
    ...
    private static final String AUTH_TOKEN = "jafljfdalsjfda8888488484848";

    public static void start() {
        ProcessWorker worker = CentralServer.newWorker("world-list", 1000L, 4);
        worker.queue(() -> {
    ...
    private static void update(World[] worlds) {
        ...
        try {
            ...
            CentralServer.logError(t.getMessage());
        }
    }
}
